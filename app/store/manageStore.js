const state = {
  ...
  playlists: [
    {id: '14', name: 'Musiques sympas', musics: ['5er84t568e', 'azdedbgyu'], colors: [{hex: '#ff4800'}, {hex: '#ff0000'}, {hex: '#ffaa00'}]},
    {id: '22', name: 'Playlist longue', musics: ['bertertb', 'a65468e468v4', 'stlkapml'], colors: [{hex: '#000000'}, {hex: '#0532ff'}, {hex: '#FFFFFF'}]}
  ],
  searchResult: []
}
